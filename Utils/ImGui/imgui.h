...
namespace ImGui
{
    namespace Fonts
    {
        static ImFont* FontAwesome6;
        static ImFont* MuseoSansMain;
        static ImFont* MuseoSans500;
    }
    ...
    IMGUI_API bool          Tab(bool selected, const char* icon, const char* label, const ImVec2& size_arg);
    IMGUI_API bool          SubTab(bool selected, const char* label, const char* name, const ImVec2& size_arg);
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/imgui/issues/3361
    IMGUI_API bool          CustomSliderFloat(const char* label, const char* name, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    ...
    IMGUI_API bool          CustomSliderInt(const char* label, const char* name, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt(const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          CustomSliderScalar(const char* label, const char* name, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
...
namespace ImGui
{
    IMGUI_API bool          CustomBeginChild(const char* str_id, const char* name, const ImVec2& size = ImVec2(0, 0), ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = ImGuiWindowFlags_NoScrollbar);
