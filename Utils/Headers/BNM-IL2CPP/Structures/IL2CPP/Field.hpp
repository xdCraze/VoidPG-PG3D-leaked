...
namespace BNM
{
    ...
    public:
        ...
        int Flags()
        {
            return BNM::ExportCall::FieldGetFlags((void *)this);
        }
        bool isStatic()
        {
            return (this->Flags() & (int)BNM::Field::Attributes::Static) != 0;
        }

        int Offset()
        {
            return BNM::ExportCall::FieldGetOffset((void *)this);
        }
        ...
        T GetValue(void *instance = nullptr)
        {
            if (this->isStatic())
            {
                if (instance == nullptr)
                {
                    return (T)BNM::ExportCall::GetStaticFieldValue((void *)this);
                }
                else
                {
        ...
        const char *Name()
        {
            return BNM::ExportCall::FieldGetName((void *)this);
        }
    };
}