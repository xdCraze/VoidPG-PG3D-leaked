...
namespace BNM
{
    ...
    public:
        ...
        const char *Name()
        {
            return BNM::ExportCall::MethodGetName((void *)this);
        }
        ...
        uint64_t VA()
        {
            ...
            void *SR_Module = BNM::ExportCall::ClassFromName(BNM::ExportCall::AssemblyGetImage(BNM::ExportCall::GetAssemblyFromDomain(BNM::ExportCall::GetDomain(), "mscorlib")), "System.Reflection", "Module");
            BNM::ExportCall::RuntimeClassInit(SR_Module);
            void *FilterTypeName_obj = BNM::ExportCall::GetStaticFieldValue(BNM::ExportCall::FieldFromName(SR_Module, "FilterTypeName"));
            void *FilterTypeName_klass = BNM::ExportCall::ObjectGetClass(FilterTypeName_obj);
            int method_offset = BNM::ExportCall::FieldGetOffset(BNM::ExportCall::FieldFromName(FilterTypeName_klass, "method"));
            int method_ptr_offset = BNM::ExportCall::FieldGetOffset(BNM::ExportCall::FieldFromName(FilterTypeName_klass, "method_ptr"));
        ...
        uint64_t RVA()
        {
            return (uint64_t)(this->VA()) - (uint64_t)BNM::Exports::GameAssembly;
        }
