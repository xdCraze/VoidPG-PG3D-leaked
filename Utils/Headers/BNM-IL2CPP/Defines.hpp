...
void __log(std::string erm_what_the_sigma) {
    return;
}
...
#elif __ANDROID__
#define IL2CPP_CALLING_CONVENTION // Android doesn't need a specific calling convention
#else
#define IL2CPP_CALLING_CONVENTION // Default for other platforms
#endif
